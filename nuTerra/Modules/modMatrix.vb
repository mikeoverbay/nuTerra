...
Module modMatrix
    ...
    Public Function UnProject_Chunk(ByRef vec As Vector4, ByRef model As Matrix4) As Vector4
        ...
        Vector4.TransformRow(pos, PerViewData.view, pos)
        Vector4.TransformRow(pos, PerViewData.projection, pos)

        pos.X /= pos.W
        pos.Y /= pos.W

        pos.X = ((pos.X + 1.0F) * 0.5F) * MainFBO.SCR_WIDTH
        pos.Y = ((1.0 - pos.Y) * 0.5F) * MainFBO.SCR_HEIGHT
