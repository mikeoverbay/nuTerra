...
Public Class MapMinimap
    ...
    Public Sub New(scene As MapScene)
        Me.scene = scene
        MINI_LETTERS_ID = TextureMgr.load_png_image_from_file("mini_letters.png", False, False)
        MINI_NUMBERS_ID = TextureMgr.load_png_image_from_file("mini_numbers.png", False, False)
        MINI_TRIM_VERT_ID = TextureMgr.load_png_image_from_file("mini_trim_vert.png", False, False)
        MINI_TRIM_HORZ_ID = TextureMgr.load_png_image_from_file("mini_trim_horz.png", False, False)
    End Sub
    ...
    Public Sub draw_mini_map()
        ...
        Dim cx = MainFBO.width - MINI_MAP_SIZE
        Dim cy = MainFBO.height - MINI_MAP_SIZE
    ...
    Public Sub get_world_Position_In_Minimap_Window()
        ...
        Dim top = MainFBO.height - MINI_MAP_SIZE
