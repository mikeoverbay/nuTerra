...
Module LQ_Texture_creator
    ...
    Private Sub create_layer(ByVal map As Integer)
        ...
        With theMap.render_set(map)
            ...
            theMap.render_set(map).layer.render_info(0).atlas_id.BindUnit(1)
            theMap.render_set(map).layer.render_info(1).atlas_id.BindUnit(2)
            theMap.render_set(map).layer.render_info(2).atlas_id.BindUnit(3)
            theMap.render_set(map).layer.render_info(3).atlas_id.BindUnit(4)
            theMap.render_set(map).layer.render_info(4).atlas_id.BindUnit(5)
            theMap.render_set(map).layer.render_info(5).atlas_id.BindUnit(6)
            theMap.render_set(map).layer.render_info(6).atlas_id.BindUnit(7)
            theMap.render_set(map).layer.render_info(7).atlas_id.BindUnit(8)
