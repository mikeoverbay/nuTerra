...
void nuTerraCPP::Utils::CompressDXT5(array<System::Byte>^ in, System::IntPtr out, System::Int32 width, System::Int32 height)
{
	pin_ptr<uint8_t> inBuf = &in[0];

	int out_bytes = 0;
	CompressImageDXT5(inBuf, (byte*)out.ToPointer(), width, height, out_bytes);
}
